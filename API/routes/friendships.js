...
router.post('/', jsonparser, (req, res, next) => {
    ...
    friendshipController.sendRequest(req.body.requester, req.body.requestee, res);
...
router.get('/friends', jsonparser, (req, res, next) => {
    ...
    friendshipController.returnFriendsList(req.body.currentUserID, res);
});
...
router.put('/accept', jsonparser, (req, res, next) => {
    ...
    friendshipController.acceptRequest(req.body.currentUserID, req.body.OtherUserID, res);
});
